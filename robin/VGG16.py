...
img_path = os.path.join(base_dir,'creative_commons_elephant.jpg')
...
african_elephant_output = model_VGG16.output[:, 386]
...
cv2.imwrite(os.path.join(base_dir,'heat_map_elephant.jpg'),superimposed_img)